...
do
    loadFile("KfjWApr8", "startup.lua")
    loadFile("CnTEuWTc", "Button.lua")
    loadFile("jkM9zURj", "Ball.lua")
    loadFile("ttppX0cD", "Commons.lua")
    loadFile("4ZAs1dCw", "Credit.lua")
    loadFile("s4c3wixy", "cashout.lua")
    loadFile("eLfF1Aw8", "plinko.lua")
    os.reboot()
end
