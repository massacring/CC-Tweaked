...
do
    loadFile("V82gasfw", "MassaMainLib")
    loadFile("7EqEuhSd", "MassaTurtleLib")
    loadFile("3yCV4gLc", "MassaMiningTurtleLib")
    loadFile("ScvYuRq2", "VerticalMining")
    loadFile("RnZyikEa", "MineArea")
	loadFile("XYkws1nK", "VeinMine")
	loadFile("KYtD6iYa", "DigStaircase")
	loadFile("bQLQ1vXq", "StripMine")
	loadFile("SXfhhzyd", "Move")
	loadFile("hzYdVJn0", "Dig")
	loadFile("9Ygikdts", "Craft")
	loadFile("pDp1xCtY", "Place")
	loadFile("C18BAMxn", "Select")
	loadFile("EphWgujH", "Turn")
    os.reboot()
end
